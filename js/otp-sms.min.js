...
jQuery(document).on("click", ".sa_myaccount_btn", function(e) {
    jQuery('.loginwithotp').removeAttr('inert');
    ...
    if (sa_otp_settings['hide_default_login_form'] == 'on') {
        setTimeout(function() { jQuery(".sa-showlogin").trigger("click") }, 10);
    }
});
...
function saResendOTP(obj) {
    ...
    jQuery(".sa-otp-initiated .sa-otp-btn-init").trigger("click");
    return false;
}
...
function saInitOTPProcess(obj, action_url, data_obj, otp_resend_timer = 15, success_cb = null, failure_cb = null, submit_selector = null) {
    ...
    jQuery('form').removeClass('sa-otp-initiated');
    $sa = jQuery;
    $sa.ajax({
...
function validateOtp(event) {
    ...
    var c_form = jQuery(".sa-otp-initiated");
...
function initialiseCountrySelector(phoneSelector = '.phone-valid') {
    ...
    var show_default_cc = "";
    var mob_field = jQuery(phoneSelector);
    ...
    jQuery(phoneSelector).on("countrychange", function() {
